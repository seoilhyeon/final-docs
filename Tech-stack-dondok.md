...
| Database | MySQL 8.0 | `ERD-dondok.md`, `adr/ADR-mvp-tech-architecture.md` |
...
| File Storage | AWS S3 | `API-spec-dondok.md`, `adr/ADR-mvp-tech-architecture.md` |
| Frontend | React, Vite, Axios | `adr/ADR-mvp-tech-architecture.md` |
| Notification | SSE, Email | `PRD-dondok.md`, `API-spec-dondok.md`, `adr/ADR-mvp-tech-architecture.md` |
| Payment | 토스페이먼츠 샌드박스 | `API-spec-dondok.md`, `adr/ADR-mvp-tech-architecture.md` |
| AI | Claude API | `PRD-dondok.md`, `API-spec-dondok.md` |
...
| API Contract | REST + JSON | `API-spec-dondok.md` |
| Auth | JWT Bearer token | `API-spec-dondok.md`, `ERD-dondok.md` |

## 3. Ownership reference map

| 주제 | Owner |
| --- | --- |
| 제품 목표, 사용자 가치, MVP 범위 | `PRD-dondok.md` |
| API/Auth/SSE 외부 계약 | `API-spec-dondok.md` |
| `member.uuid`, DB 구조, persistence invariant | `ERD-dondok.md` |
