    ...
    subgraph Dondok["🟦 Dondok System Boundary"]
        ...
        subgraph POST["마감 이후 · 정산 확정 단계"]
            ...
            subgraph PROJ["④ 예상 «참고값»"]
                ...
                UC14(("UC-A14<br/>종료 후 현재 기준<br/>예상 환급금<br/>(최종 ❌)"))
                UC13 -.선행.-> UC14
            end
...
| 전원 실패 = 0원 환급 | ❌ 원금 환급. 누군가의 실패가 다른 추가 환급으로 가지 않음 | UC-A16, §1.5, PF-017 |
| 종료 후 현재 기준 예상 = 최종 | ❌ 현재 기준 예상일 뿐. 최종 정산과 다를 수 있음 | UC-A14, PF-002 |
